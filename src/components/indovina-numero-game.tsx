...
import {Boot} from "@/phaser/indovina-numero/scenes/boot"; //*
import {Game} from "@/phaser/indovina-numero/scenes/game"; //*
import {Outro} from "@/phaser/indovina-numero/scenes/outro"; //*
import {Tutorial} from "@/phaser/indovina-numero/scenes/tutorial"; //*
import {ExitManager} from "@/phaser/indovina-numero/scenes/exit-manager"; //*
import {TimerManager} from "@/phaser/indovina-numero/scenes/timer-manager"; //*
import {IndovinaNumeroAssetConf} from "@/phaser/indovina-numero/shared/config/asset-conf.const"; //*
import {GameManager} from "@/phaser/indovina-numero/scenes/game-manager"; //* //*
import {IndovinaNumeroConfig} from "@/phaser/indovina-numero/config/indovina-numero-config"; //* //*

const assetConf = IndovinaNumeroAssetConf; //* Generalizzazione
const gameName = "indovina-numero"; //* Generalizzazione

export default function IndovinaNumeroGame({
  //*
  isTesting,
  setLevelComplete,
  setExitGame,
