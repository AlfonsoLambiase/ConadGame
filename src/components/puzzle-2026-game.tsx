...
import {Tutorial} from "@/phaser/puzzle-2026/scenes/tutorial"; //*
import {ExitManager} from "@/phaser/puzzle-2026/scenes/exit-manager"; //*
import {TimerManager} from "@/phaser/puzzle-2026/scenes/timer-manager"; //*
import {Puzzle2026AssetConf} from "@/phaser/puzzle-2026/shared/config/asset-conf.const"; //*
import {GameManager} from "@/phaser/puzzle-2026/scenes/game-manager"; //* //*
import {Puzzle2026Config} from "@/phaser/puzzle-2026/config/puzzle-2026-config"; //* //*

const assetConf = Puzzle2026AssetConf; //* Generalizzazione
const gameName = "puzzle-2026"; //* Generalizzazione

export default function Puzzle2026Game({
  //*
  isTesting,
  setLevelComplete,
  setExitGame,
