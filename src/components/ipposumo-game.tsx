...
import {Boot} from "@/phaser/ipposumo/scenes/boot"; //*
import {Game} from "@/phaser/ipposumo/scenes/game"; //*
import {Outro} from "@/phaser/ipposumo/scenes/outro"; //*
import {Tutorial} from "@/phaser/ipposumo/scenes/tutorial"; //*
import {ExitManager} from "@/phaser/ipposumo/scenes/exit-manager"; //*
import {TimerManager} from "@/phaser/ipposumo/scenes/timer-manager"; //*
import {IpposumoAssetConf} from "@/phaser/ipposumo/shared/config/asset-conf.const"; //*
import {GameManager} from "@/phaser/ipposumo/scenes/game-manager"; //* //*
import {IpposumoConfig} from "@/phaser/ipposumo/config/ipposumo-config"; //* //*

const assetConf = IpposumoAssetConf; //* Generalizzazione
const gameName = "ipposumo"; //* Generalizzazione

export default function IpposumoGame({
  //*
  isTesting,
  setLevelComplete,
  setExitGame,
