...
export class UIManager {
  ...
  // Depth level per l'UI - più alto di qualsiasi altro elemento
  ...
  createUI(): void {
    ...
    const centerY = this.gameScene.setDynamicValueBasedOnScale(45, 140) + this.ofssetY; //* Modificare solo questo
