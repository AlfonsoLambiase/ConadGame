...
//     // GameManager prima: UI ed exit vivono sulla stessa scena del gameplay così il depth li tiene sopra corsia/palla.
...
//     this.exitButton = exitManager.createExitButton(this.gameManager, this.theme);
...
//     // La scena Game ha lista display vuota ma la main camera può ancora comporre sopra al GameManager:
//     // nascondila così pan/zoom del gameplay restano visibili.
...
//   // //! Solo per test
//   addLogoPhaser() {
//     const logoPhaser = this.gameManager.add
