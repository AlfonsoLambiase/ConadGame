  ...
  fire(x: number, y: number, track: Track, ownerSize: SnowmanSize): void {
    ...
    const offsetY =
      this.ownerSize === "Big"
        ...
        : this.currentTrack.mainGame.gameScene.setDynamicValueBasedOnScale(80, 160);
    //: this.currentTrack.mainGame.gameScene.setDynamicValueBasedOnScale(55, 110);
    ...
    if (!mainGame.isGameOver) {
      ...
      this.setVelocityX(
        this.currentTrack.mainGame.gameScene.setDynamicValueBasedOnScale(-300, -1000),
      );
      this.setAccelerationX(
        this.currentTrack.mainGame.gameScene.setDynamicValueBasedOnScale(-200, -800),
      );
    } else {
