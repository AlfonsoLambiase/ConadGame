...
export class Tutorial extends Phaser.Scene {
  ...
  constructor() {
    super({key: BottleSortPuzzleAssetConf.scene.tutorial});
  }
  ...
  //     GameDemo01AssetConf.image.road,
  //     //"road",
  //   );
  ...
  //     this.width, // Ridimensionamento X
  //     1080, // Ridimensionamento Y
  //     //GameDemo01AssetConf.image.roadBackground,
  //     "roadBackground",
  //   );
  ...
  addAnims() {
    ...
    this.tutorialPlayer01 = this.#createTutorialPlayerAnimation(
      BottleSortPuzzleAssetConf.keyAnim.animTutorialPlayer01,
      BottleSortPuzzleAssetConf.spritesheet.tutorialPlayer01.key,
      38,
    );

    this.tutorialText01 = this.#createTutorialTextAnimation(
      BottleSortPuzzleAssetConf.keyAnim.animStartTutorialText01,
      BottleSortPuzzleAssetConf.spritesheet.tutorialText01.key,
      0,
      2,
    );

    this.tutorialText01 = this.#createTutorialTextAnimation(
      BottleSortPuzzleAssetConf.keyAnim.animEndTutorialText01,
      BottleSortPuzzleAssetConf.spritesheet.tutorialText01.key,
      3,
      5,
    );
    ...
    this.tutorialPlayer02 = this.#createTutorialPlayerAnimation(
      BottleSortPuzzleAssetConf.keyAnim.animTutorialPlayer02,
      BottleSortPuzzleAssetConf.spritesheet.tutorialPlayer02.key,
      37,
    );

    this.tutorialText02 = this.#createTutorialTextAnimation(
      BottleSortPuzzleAssetConf.keyAnim.animStartTutorialText02,
      BottleSortPuzzleAssetConf.spritesheet.tutorialText02.key,
      0,
      2,
    );

    this.tutorialText02 = this.#createTutorialTextAnimation(
      BottleSortPuzzleAssetConf.keyAnim.animEndTutorialText02,
      BottleSortPuzzleAssetConf.spritesheet.tutorialText02.key,
      3,
      5,
    );
    ...
    this.tutorialPlayer03 = this.#createTutorialPlayerAnimation(
      BottleSortPuzzleAssetConf.keyAnim.animTutorialPlayer03,
      BottleSortPuzzleAssetConf.spritesheet.tutorialPlayer03.key,
      38,
    );

    this.tutorialText03 = this.#createTutorialTextAnimation(
      BottleSortPuzzleAssetConf.keyAnim.animStartTutorialText03,
      BottleSortPuzzleAssetConf.spritesheet.tutorialText03.key,
      0,
      2,
    );

    this.tutorialText03 = this.#createTutorialTextAnimation(
      BottleSortPuzzleAssetConf.keyAnim.animEndTutorialText03,
      BottleSortPuzzleAssetConf.spritesheet.tutorialText03.key,
      3,
      5,
    );
  ...
  addButton(normalSizeButton: number, reduceSizeButton: number) {
    this.startButton = this.add
      .sprite(this.width / 2, this.height - 50, BottleSortPuzzleAssetConf.image.tutorialTastoAvanti)
      .setInteractive()
      .setOrigin(0.5, 1)
      .setScrollFactor(0)
  ...
  #playTutorial01(normalSizeButton: number, reduceSizeButton: number) {
    ...
    this.tutorialPlayer01.play(BottleSortPuzzleAssetConf.keyAnim.animTutorialPlayer01);
    ...
    this.tutorialPlayer01.on(
      ...
      (animation: Phaser.Animations.Animation, frame: Phaser.Animations.AnimationFrame) => {
        if (!this.isTutorialActive) return;
        if (
          animation.key === BottleSortPuzzleAssetConf.keyAnim.animTutorialPlayer01 &&
          frame.index === 12
        ) {
          this.tutorialText01.setVisible(true);
          this.tutorialText01.play(BottleSortPuzzleAssetConf.keyAnim.animStartTutorialText01);
        }
      },
    );
    ...
    this.tutorialPlayer01.once(
      Phaser.Animations.Events.ANIMATION_COMPLETE_KEY +
        BottleSortPuzzleAssetConf.keyAnim.animTutorialPlayer01,
      () => {
        this.tutorialText01.play(BottleSortPuzzleAssetConf.keyAnim.animEndTutorialText01);
  ...
  #playTutorial02(normalSizeButton: number, reduceSizeButton: number) {
    ...
    this.tutorialPlayer02.play(BottleSortPuzzleAssetConf.keyAnim.animTutorialPlayer02);
    ...
    this.tutorialPlayer02.on(
      ...
      (animation: Phaser.Animations.Animation, frame: Phaser.Animations.AnimationFrame) => {
        if (!this.isTutorialActive) return;
        if (
          animation.key === BottleSortPuzzleAssetConf.keyAnim.animTutorialPlayer02 &&
          frame.index === 12
        ) {
          this.tutorialText02.setVisible(true);
          this.tutorialText02.play(BottleSortPuzzleAssetConf.keyAnim.animStartTutorialText02);
        }
      },
    );
    ...
    this.tutorialPlayer02.once(
      Phaser.Animations.Events.ANIMATION_COMPLETE_KEY +
        BottleSortPuzzleAssetConf.keyAnim.animTutorialPlayer02,
      () => {
        this.tutorialText02.play(BottleSortPuzzleAssetConf.keyAnim.animEndTutorialText02);
  ...
  #playTutorial03(normalSizeButton: number, reduceSizeButton: number) {
    ...
    this.tutorialPlayer03.play(BottleSortPuzzleAssetConf.keyAnim.animTutorialPlayer03);
    ...
    this.tutorialPlayer03.on(
      ...
      (animation: Phaser.Animations.Animation, frame: Phaser.Animations.AnimationFrame) => {
        if (!this.isTutorialActive) return;
        if (
          animation.key === BottleSortPuzzleAssetConf.keyAnim.animTutorialPlayer03 &&
          frame.index === 12
        ) {
          this.tutorialText03.setVisible(true);
          this.tutorialText03.play(BottleSortPuzzleAssetConf.keyAnim.animStartTutorialText03);
        }
      },
    );
    ...
    this.tutorialPlayer03.once(
      Phaser.Animations.Events.ANIMATION_COMPLETE_KEY +
        BottleSortPuzzleAssetConf.keyAnim.animTutorialPlayer03,
      () => {
        this.tutorialText03.play(BottleSortPuzzleAssetConf.keyAnim.animEndTutorialText03);
  ...
  #functionButton(normalSizeButton: number, reduceSizeButton: number) {
    ...
    this.time.delayedCall(200, () => {
      ...
      this.scene.start(BottleSortPuzzleAssetConf.scene.game);
    });
  }
