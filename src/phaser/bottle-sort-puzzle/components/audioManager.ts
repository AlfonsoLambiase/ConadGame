...
export class AudioManager {
  ...
  playAudio(key: keyof typeof BottleSortPuzzleAssetConf.audio): void {
    if (this.audios[key]) {
  ...
  playBackgroundMusic(): void {
    const theme = this.scene.sound.add(BottleSortPuzzleAssetConf.audio.music);
...
//  this.gameScene.audioManager.playAudio(GameDemo01AssetConf.audio.bubblepop);
