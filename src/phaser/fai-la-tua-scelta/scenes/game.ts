...
export class Game extends Phaser.Scene {
  ...
  /**
   * @param resultOverride — se passato (morra: primo a 3), usa Win/Failed RPS; altrimenti legacy score/maxScore o vite.
   */
  gameOver(resultOverride?: "Win" | "Failed"): void {
    if (!this.isGameOver) {
      ...
      const won =
        resultOverride !== undefined
          ? resultOverride === "Win"
          : this.uiManager.score >= this.uiManager.maxScore;
