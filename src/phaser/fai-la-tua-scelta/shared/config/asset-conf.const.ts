export const FaiLaTuaSceltaAssetConf = {
  scene: {
    boot: "boot",
    tutorial: "tutorial",
    game: "game",
  ...
  image: {
    ...
    // for specific game
    carta_attivo: "carta_attivo",
    carta_inattivo: "carta_inattivo",
    forbice_attivo: "forbice_attivo",
    forbice_inattivo: "forbice_inattivo",
    sasso_attivo: "sasso_attivo",
    sasso_inattivo: "sasso_inattivo",
    sasso: "sasso",
    asse_player: "asse_player",
    asse_enemy: "asse_enemy",
    // for exitManager
