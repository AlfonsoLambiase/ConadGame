...
export class Tutorial extends Phaser.Scene {
  ...
  constructor() {
    super({key: BasketAssetConf.scene.tutorial});
  }
  ...
  //     GameDemo02AssetConf.image.road,
  //     //"road",
  //   );
  ...
  //     this.width, // Ridimensionamento X
  //     1080, // Ridimensionamento Y
  //     //GameDemo02AssetConf.image.roadBackground,
  //     "roadBackground",
  //   );
  ...
  addAnims() {
    ...
    this.tutorialPlayer01 = this.#createTutorialPlayerAnimation(
      BasketAssetConf.keyAnim.animTutorialPlayer01,
      BasketAssetConf.spritesheet.tutorialPlayer01.key,
      38,
    );

    this.tutorialText01 = this.#createTutorialTextAnimation(
      BasketAssetConf.keyAnim.animStartTutorialText01,
      BasketAssetConf.spritesheet.tutorialText01.key,
      0,
      2,
    );

    this.tutorialText01 = this.#createTutorialTextAnimation(
      BasketAssetConf.keyAnim.animEndTutorialText01,
      BasketAssetConf.spritesheet.tutorialText01.key,
      3,
      5,
    );
    ...
    this.tutorialPlayer02 = this.#createTutorialPlayerAnimation(
      BasketAssetConf.keyAnim.animTutorialPlayer02,
      BasketAssetConf.spritesheet.tutorialPlayer02.key,
      37,
    );

    this.tutorialText02 = this.#createTutorialTextAnimation(
      BasketAssetConf.keyAnim.animStartTutorialText02,
      BasketAssetConf.spritesheet.tutorialText02.key,
      0,
      2,
    );

    this.tutorialText02 = this.#createTutorialTextAnimation(
      BasketAssetConf.keyAnim.animEndTutorialText02,
      BasketAssetConf.spritesheet.tutorialText02.key,
      3,
      5,
    );
    ...
    this.tutorialPlayer03 = this.#createTutorialPlayerAnimation(
      BasketAssetConf.keyAnim.animTutorialPlayer03,
      BasketAssetConf.spritesheet.tutorialPlayer03.key,
      38,
    );

    this.tutorialText03 = this.#createTutorialTextAnimation(
      BasketAssetConf.keyAnim.animStartTutorialText03,
      BasketAssetConf.spritesheet.tutorialText03.key,
      0,
      2,
    );

    this.tutorialText03 = this.#createTutorialTextAnimation(
      BasketAssetConf.keyAnim.animEndTutorialText03,
      BasketAssetConf.spritesheet.tutorialText03.key,
      3,
      5,
    );
  ...
  addButton(normalSizeButton: number, reduceSizeButton: number) {
    this.startButton = this.add
      .sprite(this.width / 2, this.height - 50, BasketAssetConf.image.tutorialTastoAvanti)
      .setInteractive()
      .setOrigin(0.5, 1)
      .setScrollFactor(0)
  ...
  #playTutorial01(normalSizeButton: number, reduceSizeButton: number) {
    ...
    this.tutorialPlayer01.play(BasketAssetConf.keyAnim.animTutorialPlayer01);
    ...
    this.tutorialPlayer01.on(
      ...
      (animation: Phaser.Animations.Animation, frame: Phaser.Animations.AnimationFrame) => {
        if (!this.isTutorialActive) return;
        if (
          animation.key === BasketAssetConf.keyAnim.animTutorialPlayer01 &&
          frame.index === 12
        ) {
          this.tutorialText01.setVisible(true);
          this.tutorialText01.play(BasketAssetConf.keyAnim.animStartTutorialText01);
        }
      },
    );
    ...
    this.tutorialPlayer01.once(
      Phaser.Animations.Events.ANIMATION_COMPLETE_KEY +
        BasketAssetConf.keyAnim.animTutorialPlayer01,
      () => {
        this.tutorialText01.play(BasketAssetConf.keyAnim.animEndTutorialText01);
  ...
  #playTutorial02(normalSizeButton: number, reduceSizeButton: number) {
    ...
    this.tutorialPlayer02.play(BasketAssetConf.keyAnim.animTutorialPlayer02);
    ...
    this.tutorialPlayer02.on(
      ...
      (animation: Phaser.Animations.Animation, frame: Phaser.Animations.AnimationFrame) => {
        if (!this.isTutorialActive) return;
        if (
          animation.key === BasketAssetConf.keyAnim.animTutorialPlayer02 &&
          frame.index === 12
        ) {
          this.tutorialText02.setVisible(true);
          this.tutorialText02.play(BasketAssetConf.keyAnim.animStartTutorialText02);
        }
      },
    );
    ...
    this.tutorialPlayer02.once(
      Phaser.Animations.Events.ANIMATION_COMPLETE_KEY +
        BasketAssetConf.keyAnim.animTutorialPlayer02,
      () => {
        this.tutorialText02.play(BasketAssetConf.keyAnim.animEndTutorialText02);
  ...
  #playTutorial03(normalSizeButton: number, reduceSizeButton: number) {
    ...
    this.tutorialPlayer03.play(BasketAssetConf.keyAnim.animTutorialPlayer03);
    ...
    this.tutorialPlayer03.on(
      ...
      (animation: Phaser.Animations.Animation, frame: Phaser.Animations.AnimationFrame) => {
        if (!this.isTutorialActive) return;
        if (
          animation.key === BasketAssetConf.keyAnim.animTutorialPlayer03 &&
          frame.index === 12
        ) {
          this.tutorialText03.setVisible(true);
          this.tutorialText03.play(BasketAssetConf.keyAnim.animStartTutorialText03);
        }
      },
    );
    ...
    this.tutorialPlayer03.once(
      Phaser.Animations.Events.ANIMATION_COMPLETE_KEY +
        BasketAssetConf.keyAnim.animTutorialPlayer03,
      () => {
        this.tutorialText03.play(BasketAssetConf.keyAnim.animEndTutorialText03);
  ...
  #functionButton(normalSizeButton: number, reduceSizeButton: number) {
    ...
    this.time.delayedCall(200, () => {
      ...
      this.scene.start(BasketAssetConf.scene.game);
    });
  }
